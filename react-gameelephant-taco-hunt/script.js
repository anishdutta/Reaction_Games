...
const App = React.createClass({ displayName: "App",
  ...
  render() {
    ...
    return (
      ...
      React.createElement("div", { className: "mutebutton", onClick: this._handleSoundChange },
      React.createElement("img", { src: url })),

      React.createElement(Controls, { _updateScore: this._updateScore, isPlaying: this.state.isPlaying, _isGameOver: this._isGameOver }),
      React.createElement(HeartMeter, { score: this.state.score }),
      React.createElement(Opener, { startGame: this.startGame }),
      React.createElement(Won, { _isGameWon: this._isGameWon, startGame: this.startGame, finalScore: this.state.finalScore }),
...
const Controls = React.createClass({ displayName: "Controls",
  ...
  render() {
    return (
      React.createElement("div", null,
      React.createElement("svg", { className: "controls controls-top", id: "touch-controls", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 210.8 101.5", "aria-labelledby": "title" },
      React.createElement("title", { id: "controls" }, "controls"),
      React.createElement("rect", { x: "120.2", y: "44.7", width: "59.3", height: "49.21", rx: "15", ry: "15", transform: "rotate(-180 146.45 66.7)", fill: "#006666" }),
      React.createElement("g", { id: "up", onClick: this._elephantDirection.bind(this, "up") }, React.createElement("path", { fill: "#fff", d: "M150.9 49.5l-7.1-4.6-7.1 4.6h2.9V57h6.2v-7.5h5.1z" }), React.createElement("path", { d: "M138.7 50.4h-4.4L144 44l8.4 5.5-1.4.9h-3.1v6.5l-1.4.9h-7.8zm-1.3-.9h2.6v7.4h5.2v-7.4h2.6l-5.2-3.4z", fill: "#000" })),
      React.createElement("g", { id: "right", onClick: this._elephantDirection.bind(this, "right") }, React.createElement("path", { fill: "#fff", d: "M160.8 71.6l4.6-7.5-4.6-7.6v3.1h-7.5v6.6h7.5v5.4z" }), React.createElement("path", { d: "M159.9 58.6v-4.7l6.4 10.4-5.5 8.9-.9-1.5v-3.2h-6.5l-.9-1.5v-8.4zm.9-1.4V60h-7.4v5.6h7.4v2.8l3.4-5.6z", fill: "#000" })),
      React.createElement("g", { id: "down", onClick: this._elephantDirection.bind(this, "down") }, React.createElement("path", { fill: "#fff", d: "M150.9 78l-7.1 4.6-7-4.6h2.9v-7.5h6.2V78h5z" }), React.createElement("path", { d: "M138.8 69.7h7.7l1.4.9v6.5h3l1.4.9-8.3 5.5-9.7-6.4h4.4zm3.9 11.7l5.2-3.4h-2.6v-7.4h-5.2V78h-2.6z", fill: "#000" })),
      React.createElement("g", { id: "left", onClick: this._elephantDirection.bind(this, "left") }, React.createElement("path", { fill: "#fff", d: "M126.2 71.6l-4.7-7.5 4.7-7.6v3.1h7.4v6.6h-7.4v5.4z" }), React.createElement("path", { d: "M134.4 58.6v8.3l-.9 1.5H127v3.3l-.9 1.5-5.5-8.9 6.4-10.4v4.8zm-11.7 4.2l3.4 5.6v-2.8h7.4V60h-7.4v-2.8z", fill: "#000" }))),

      React.createElement("div", { className: "elephantContainer", ref: "elContainer" },
      React.createElement(Elephant, null),
      React.createElement("div", { className: "deWow wow", ref: "deWow" }),
      React.createElement("div", { className: "inWow wow", ref: "inWow" }),
      React.createElement("div", { className: "mWow wow", ref: "mWow" })),

      React.createElement("div", { className: "tacoContainer", ref: "tContainer" },
      React.createElement("div", { className: "taco", ref: "taco" })),

      React.createElement("div", { className: "margaritaContainer", ref: "mContainer" },
      React.createElement("div", { className: "margarita", ref: "margarita" })),

      React.createElement("div", { className: "textContainer", ref: "txContainer" },
      React.createElement(Text, { ref: "textmessages" })),
...
const HeartMeter = React.createClass({ displayName: "HeartMeter",
  render() {
    return (
      React.createElement("div", null,
      React.createElement("svg", { className: "heartmeter", xmlns: "http://www.w3.org/2000/svg", width: "250", height: "50", viewBox: "0 0 1741.8 395.6" },
      React.createElement("path", { d: "M1741.8 197.7c0 109.3-89 197.8-198.8 197.8a198.6 198.6 0 0 1-158.5-78.4H11.2A11.2 11.2 0 0 1 0 305.9V89.5a11.2 11.2 0 0 1 11.2-11.1h1373.4A198.8 198.8 0 0 1 1543 0c109.8 0 198.8 88.5 198.8 197.7z", fill: "#000" }),
      React.createElement("path", { d: "M1591.8 127c-18.3 0-34.1 14.8-41.4 30.3-7.3-15.5-23.1-30.3-41.4-30.3a45.7 45.7 0 0 0-45.7 45.5c0 51.1 51.8 64.5 87.1 115.1 33.4-50.2 87.1-65.6 87.1-115.1a45.7 45.7 0 0 0-45.7-45.5z", fill: "#b29968" }),
...
const Lost = React.createClass({ displayName: "Lost",
  ...
  render() {
    return (
      React.createElement("div", { className: "loseContainer", ref: "loseContainer" },
      React.createElement("div", { className: "overlay overlayLosing" }),
      React.createElement("div", { className: "hangry" },
      React.createElement("h1", { className: "hangry-text" }, "Aw Nuts!"),


      React.createElement("div", { className: "hangry-text" }, "You were overruled and didn't get to eat any tacos. Sounds like you're going to a movie you already saw instead."),


      React.createElement("div", { className: "hangry-svg" }),
      React.createElement("button", { className: "start", onClick: this._handleRestartClick }, "Play again!"))));
...
const Text = React.createClass({ displayName: "Text",
  ...
  render() {
    return (
      React.createElement("svg", { className: "text", width: "65.9", height: "80.6", viewBox: "0 0 65.9 80.6", role: "presentation" },
      React.createElement("path", { ref: "bkText", fill: "#d16f43", d: "M.4 7.4H46v62.47H.4z" }),
      React.createElement("path", { fill: "#fcfbfa", d: "M27.5 29.8h33v13.75h-33z" }),
      React.createElement("path", { fill: "#e2dfd8", d: "M17.2 69.8h13.4v10.79H17.2z" }),
...
const Elephant = React.createClass({ displayName: "Elephant",
  render() {
    return (
      React.createElement("svg", { className: "elephant", xmlns: "http://www.w3.org/2000/svg", viewBox: "15 15 255 130" },
      React.createElement("path", { id: "ear-right", className: "st0", d: "M173.9 62s58.7-16.7 68.3-32.3c9.7-15.7 19.7-11 18-2.7-1.7 8.3-40 49.3-49.7 47.7-9.7-1.7-27.7 7.1-31 0-3.2-7-15.7-9-5.6-12.7z" }),
      React.createElement("path", { className: "st1", d: "M154.1 117.3s16.5 6.9 18.5 11.2c2 4.2 1.5 6 3.5 5.8s11.2-5.8 8-12.9-23-24.9-28.8-17.4-6.2 12.4-1.2 13.3z" }),
      React.createElement("ellipse", { className: "st0", cx: "130.8", cy: "88.7", rx: "35.2", ry: "28.7" }),
      React.createElement("ellipse", { className: "st2", cx: "87.4", cy: "92.8", rx: "10.8", ry: "4.2" }),
      React.createElement("path", { className: "st1", d: "M208.3 104.6c0 .3-.1.5-.4.6l-16.1 2.8c-.3 0-.5-.1-.6-.4l-2.3-12.3c0-.3.1-.5.5-.6l16-3.8h.1c.1 0 .2.1.3.1.1 0 .2.1.2.3l2.3 13.3z" }),
      ...
      React.createElement("path", { className: "st2", d: "M120.9 116.5s-20.3-44.5-7.5-52.8c0 0-65.1 26.3 7.5 52.8z" }),
      React.createElement("ellipse", { className: "st2", cx: "87.8", cy: "99.8", rx: "19.2", ry: "7.8" }),
      React.createElement("path", { className: "st2", d: "M204.8 63.6s-20.1-29.6-44-11.9c0 0-3.9-3.3-7.3 3.3-4 7.9-5.1 7.3-5.1 7.3s-6-4.2-6.9 10.5c-.8 14.7-15.7 22.5-4.8 26.2 10.8 3.7 31.8-23.7 31.8-23.7s19.7-16.8 36.3-11.7z" }),
      React.createElement("path", { id: "ear-left", className: "st0", d: "M160.3 68.7S111.6 63 64 78.4c0 0-31.3 5.7-35 0 0 0-18.7-5.3-5.7 5.2 0 0 20.3 15.8 55.3 16s60.7-11.2 60.7-11.2l23.7-4.8c-.1-.1 23.3-13.9-2.7-14.9z" }),
      React.createElement("g", { id: "eyes" },
      React.createElement("ellipse", { className: "st3", cx: "200.7", cy: "99.5", rx: "2.2", ry: "4.5" }),
      React.createElement("ellipse", { className: "st3", cx: "219.1", cy: "94.4", rx: ".8", ry: "2.6" })),

      React.createElement("path", { className: "st4", d: "M217.1 118.3s-14.5 2-16.3-4M205.3 110.7s2 6-10.7 3.8" }),
      React.createElement("path", { className: "st1", d: "M162.3 129s-4.2-.8-6-8c-1.8-7.2-2-18-13-17s-12.5 8.8-12.5 8.8-4 6.7 7.5 17.2c0 0 2.7 1.8 3.6 6.5 1.5 8.1 20.4-7.5 20.4-7.5z" }),
      React.createElement("ellipse", { transform: "rotate(-20.12 152.072 132.685)", className: "st1", cx: "152.1", cy: "132.7", rx: "10.9", ry: "6.7" }),
      ...
      React.createElement("g", { id: "glasses" },
...
const Opener = React.createClass({ displayName: "Opener",
  ...
  render() {
    return (
      React.createElement("div", { className: "openContainer" },
      React.createElement("div", { className: "overlay overlayOpener" }),
      React.createElement("div", { className: "opener" },
      React.createElement("div", { id: "opener-text" }, "Once there was an elephant. He was excited to go out with his friends and get tacos, but they kept texting him to change the plans. Help the elephant get all the tacos and avoid flakey text messages to get to delicious glory!"),
